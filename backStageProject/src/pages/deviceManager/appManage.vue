...
<!--                </el-form-item>-->
        ...
        <div class="tableWp marginTop2">
            <el-table :data="tableData" size="small" stripe>
                ...
                <el-table-column  label="APP服务端版本号" header-align="center" align="center">
                    <template slot-scope="scope">
                        <span v-if="scope.row.serverVersion">{{scope.row.serverVersion}}</span>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
...
<!--        上传-->
        ...
        <el-dialog
            ...
            <div slot="title" class="dialogTitle clearFix">
                <span class="title">APP软件管理-审核</span>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            auditADD () {
                ...
                var filename = api.APP_AUDIT + getDataTime() + '.json';
