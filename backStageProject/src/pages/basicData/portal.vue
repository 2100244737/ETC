            ...
            <el-table :data="tableData" size="small" stripe>
                ...
                <el-table-column label="状态" header-align="center" align="center">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.status == '9' ">备用</span>
                    </template>
                </el-table-column>
                <el-table-column prop="etcGantryHex" label="Hex码" header-align="center" align="center"/>
                <el-table-column label="门架类型" header-align="center" align="center">
                    <template slot-scope="scope">
                        <span v-if="scope.row.gantryType == '0' ">路段收费门架</span>
                        <span v-if="scope.row.gantryType == '1' ">省界收费门架</span>
                    </template>
                </el-table-column>
                <el-table-column label="门架种类" header-align="center" align="center">
                    <template slot-scope="scope">
                        <span v-if="scope.row.type == '1' ">实体门架</span>
                        <span v-if="scope.row.type == '2' ">虚拟门架</span>
                    </template>
                </el-table-column>
            </el-table>
            <Pages
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                var filename = api.GANTRY + getDataTime() + '.json';
