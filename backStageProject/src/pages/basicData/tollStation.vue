            ...
            <el-table :data="tableData" size="small" stripe>
                ...
                <el-table-column label="状态" header-align="center" align="center">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.status == '4' ">停用</span>
                    </template>
                </el-table-column>

                <el-table-column prop="stationHex" label="Hex码" header-align="center" align="center"/>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                var filename = api.STATION + getDataTime() + '.json';
